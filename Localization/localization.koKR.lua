...
--[[Translation missing --]]
L["%s of %s increases %s by %.2f%%"] = "%s of %s 증가 %s by %.2f%%"
L["About DCS"] = "DCS 정보"
L["All Stats"] = "모든 능력치"
--[[ L["Attack"] = ""--]] 
...
L["Defense"] = "방어"
--[[Translation missing --]]
L["Dejablue's improved character stats panel view."] = "Dejablue의 개선된 능력치 보기 창"--]] 
...
L["Hide low level mastery"] = "저레벨 특성 숨기기"
...
----------------------------------------------------
L["Primary"] = "Primary"
L["Melee Enhancements"] = "근접 강화"
L["Spell Enhancements"] = "주문 강화"
L["\"Melee Hit: "] = "\"근접 적중: "
...
L["Armor: "] = "방어도: "
L["Ranged: "] = "원거리 숙련도: "
L["Gives a chance to block enemy melee and ranged attacks."] = "근접 또는 원거리 공격을 방어할 기회를 줍니다."
L["Gives a chance to critically strike with spells, increasing the damage dealt by 50%."] = "주문으로 치명타를 입힐수 있는 기회를 줍니다. 공격력의 50%가 증가합니다."
L["Total Mana points regenerated per tick while not casting and outside the five second rule."] = ":5초동안 주문사용을 안할시 틱당 회복되는 총 마나량"
L["Mana points regenerated every tick while casting and inside the five second rule."] = ":5초안에 주문을 사용할시 틱당 회복되는 마나량"
L["Mana points regenerated every five seconds while casting and inside the five second rule."] = ":5초안에 주문을 사용할시 매5초당 회복되는 마나량"
L[". Critical Hit immunity for a level 60 player against a raid boss occurs at 440 Defense and requires a defense skill of 140 from items and enhancements to achieve."] ="레벨 60 플레이어의 레이드 보스에 대한 치명타 면역은 440 방어 숙련도에서 발생하며, 달성하려면 아이템 및 강화에서 140의 방어 숙련이 필요합니다."
L["Total Defense is "] = "총 방어력"
L["Bonus Defense from items and enhancements is "] = "아이템과 강화로 인한 추가 방어력"
L["Base Defense including talents such as Warrior's Anticipation is "] = "직감과 같은 전사의 특성을 포함한 기본 방어력"
L["Your blocks mitigate "] = "방패 막기 흡수"
L[" melee and ranged damage."] = "근접 과 원거리 공격"
L["Gives a chance to block enemy melee and ranged attacks."] = "적의 근접과 원거리 공격을 방어할 기회를 줍니다"
L["Damage per Second: "] = " 초당 공격력:"
L["Ranged Damage: "] = "원거리 공격력:"
L["Attack Speed (seconds): "] = "공격 속도(초):"
L["Gives a chance to critically strike with melee attacks, increasing the damage dealt by 100%."] = "근접 공격으로 치명타를 입힐수 있는 기회를 줍니다. 공격력의 100%가 증가합니다."
L["Off Hand Damage: "] = "보조 장비 공격력:"
L["Damage per Second: "] = "초당 공격력:"
L["Attack Speed (seconds): "] = "공격 속도(초):"
L["Your current movement speed including items, buffs, enchants, forms, and mounts."] = "현재 이동 속도는 아이템,버프,강화,태세,탈것 등에 의해 증가됩니다."
L["The average durability of all equipped items."] = "전체 착용 장비의 평균 내구도"
L["The total repair cost of all equipped items."] = "전체 착용 장비의 평균 수리비"
L["+ Healing: "] = "치유량: "
L["+ Holy: "] = "신성 공격력: "
L["+ Arcane: "] = "비전 공격력: "
L["+ Fire: "] = "화염 공격력: "
...
L["+ Frost: "] = "냉기 공격력: "
L["+ Shadow: "] = "암흑 공격력: "
L["Hide Character Frame"] = "캐릭터 프레임 숨기기"
L["Show Character Frame"] = "캐릭터 프레임 보이기"
L["Defense Stats"] = "방어 능력치"
L["Show defense stats."] = "방어 능력치 보기"
L["Spell Stats"] = "주문 능력치"
L["Show spell stats."] = "주문 능력치 보기"
L["Melee Stats"] = "근접 능력치"
L["Show melee stats."] = "근접 능력치 보기"
L["Primary Stats"] = "기본 능력치"
L["Show Primary Stats"] = "기본 능력치 보기"
L["Displays the Character Model Rotation buttons."] = "캐릭터 미리보기창에 회전버튼 표시"
L["Rotation Buttons"] = "회전 버튼"
L["Displays the default resistance frames."] = "기본 저항력 표시"
L["Default Resistances"] = "기본 저항력"
L["Displays the default stat frames."] = "기본 능력치 창 표시"
L["Default Stats"] = "기본 능력치"
L["Displays black and white class talents background art."] = "흑백의 클래스별 배경장식 표시"
L["Monochrome Background Art"] = "모노크롬 배경 장식"
L["Displays the class talents background art."] = "클래스별 배경장식 표시"
